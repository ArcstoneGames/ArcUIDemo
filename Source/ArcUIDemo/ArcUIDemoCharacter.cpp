...
#include "UI/Presenters/ArcUIDemoJumpCounterPresenter.h"
...
AArcUIDemoCharacter::AArcUIDemoCharacter()
{
...
void AArcUIDemoCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
	...
	if (!JumpCounterPresenter)
	{
		...
		// Here we tell the Presenter on which tag(s) it will react to
...
void AArcUIDemoCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AArcUIDemoCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AArcUIDemoCharacter::Look);
	}
	else
	{
...
void AArcUIDemoCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AArcUIDemoCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
